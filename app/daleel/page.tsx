    ...
    <main id="main" className="container daleel">
      ...
      <section id="methodology" className="daleel-section">
        ...
        <ol className="methodology-list">
          ...
          <li>
            ...
            المحققة — الطبعة السلطانية لصحيح البخاري، وطبعة محمد فؤاد عبد الباقي
            لصحيح مسلم — للتأكد من اللفظ والراوي والرقم وموضع الحديث. ورابط
      ...
      <section id="limits" className="daleel-section limits-panel">
        ...
        <ul>
          ...
          <li>
            لا يحصر الإسلام في الأخلاق، ولا يجعل حسن المعاملة بديلًا عن التوحيد
            والصلاة وسائر الفرائض.
          </li>
          <li>
            لا يجمع كل أبواب الدين أو كل أدلة الأخلاق؛ فهو مدخل تعليمي قابل
            للتوسّع والتصحيح.
          </li>
          <li>
            لا يصدر فتاوى لحالاتك الخاصة، ولا يغني عن سؤال أهل العلم عند الإشكال
            أو الخلاف.
          </li>
          <li>
            لا يدّعي السلامة من الخطأ، ولا يدّعي أنه مرّ بمراجعة شرعية متخصصة،
            ولا يقيس التقوى بعدد الدروس التي قرأتها.
          </li>
        </ul>
      </section>
