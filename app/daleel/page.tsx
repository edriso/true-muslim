    ...
    <main id="main" tabIndex={-1} className="container daleel">
      ...
      <section id="source-index" className="daleel-section">
        ...
        <p>
          <Link className="text-link" href="/mujtanabat">
            وانظر ما نجتنبه مجموعًا في صفحة واحدة{' '}
      ...
      <section id="methodology" className="daleel-section">
        ...
        <ol className="methodology-list">
          ...
          <li>
            <strong>الحديث النبوي:</strong> نأخذ اللفظ والراوي والرقم والكتاب
            والباب من صفحة الحديث في طبعته المحققة: الطبعة السلطانية لصحيح
            البخاري، وطبعة محمد فؤاد عبد الباقي لصحيح مسلم. ورابط الصفحة
            المطبوعة مثبت مع كل حديث في الفهرس أعلاه. ونقتصر على هذين الكتابين.
          </li>
          <li>
            <strong>أمانة النقل:</strong> ننقل اللفظ كما هو مطبوع، فلا نضيف تشكيلًا
            ولا نصلح صياغة ولا نجمع بين روايتين، ونبيّن متى يكون النص مقتطفًا من
            حديث أطول، ومتى كان له سياق يُصدّر به. ولا ننقل شرح المحققين ولا
            تعليقاتهم على أنه من الحديث. ونرفق مع كل حديث رابطه في{' '}
            <a href="https://sunnah.com/" lang="en">
              Sunnah.com
            </a>{' '}
            تسهيلًا للرجوع إليه، ورقمه هناك هو رقم المطبوع نفسه.
          </li>
          <li>
